...
ASOS_Protocolv1::ASOS_Protocolv1(){
  ...
  t = 0x05;  info[t] = new ASOS_Protocolv1_info(0,0,0,0,0, ASOSP_OBJECT, 1);  // 0x05: "pop message command"
  t = 0x85;  info[t] = new ASOS_Protocolv1_info(0,1,1,0,1, ASOSP_OBJECT, 0);  // 0x85: "pop message response"

  t = 0x06;  info[t] = new ASOS_Protocolv1_info(0,1,0,0,1, ASOSP_OBJECT, 1);  // 0x06: "push message command"
  t = 0x86;  info[t] = new ASOS_Protocolv1_info(0,0,1,0,0, ASOSP_OBJECT, 0);  // 0x86: "push message response"
  ...
  t = 0x0d;  info[t] = new ASOS_Protocolv1_info(0,1,0,0,1, ASOSP_OBJECT, 0);  // 0x0d: "captured message"

  t = 0x0e;  info[t] = new ASOS_Protocolv1_info(0,0,0,0,0, ASOSP_OBJECT, 1);  // 0x0e: "register message capture command"
  t = 0x8e;  info[t] = new ASOS_Protocolv1_info(0,0,1,0,0, ASOSP_OBJECT, 0);  // 0x8e: "register message capture response"

  t = 0x0f;  info[t] = new ASOS_Protocolv1_info(0,0,0,0,0, ASOSP_OBJECT, 1);  // 0x0f: "cancel message capture command"
  t = 0x8f;  info[t] = new ASOS_Protocolv1_info(0,0,1,0,0, ASOSP_OBJECT, 0);  // 0x8f: "cancel message capture response"
